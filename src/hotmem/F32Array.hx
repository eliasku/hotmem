...
#elseif java
		//return JavaUnsafe.UNSAFE.putFloat(this, JavaUnsafe.BYTE_ARRAY_BASE_OFFSET + (index << 2), element);
		this[index] = element;
#elseif cs
		this[index] = element;
#end
...
#elseif java
		//return untyped __java__("hotmem.JavaUnsafe.UNSAFE.getFloat({0}, hotmem.JavaUnsafe.BYTE_ARRAY_BASE_OFFSET + ({1} << 2))", this, index);
		return this[index];
#elseif cs
		return this[index];
#else
